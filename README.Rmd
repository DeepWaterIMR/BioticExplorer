...
The app can be run on a desktop (i.e. your computer) for local files and on a [server](http://njord:8080/bioticexplorer/) and computer for both local files and the entire IMR Biotic database after downloading the database using [BioticExplorerServer](https://github.com/DeepWaterIMR/BioticExplorerServer).
